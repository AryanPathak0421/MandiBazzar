        ...
        <div className="flex gap-4 px-4 pb-2">
          {categories.map((category) => (
            ...
            >
              ...
              <div className="w-16 h-16 bg-white rounded-full shadow-md hover:shadow-lg transition-all overflow-hidden flex items-center justify-center border-2 border-green-100">
                {category.image ? (
                  <img
                    src={category.image}
                    alt={category.name}
